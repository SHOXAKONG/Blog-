...
# Directory where collected static files will go (e.g., for production)
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Keep this as your source static directory
]
...
LOGIN_URL = '/login/'  # Change this based on your login URL
